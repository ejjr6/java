	...
	function all(){
		...
		$.getJSON('${path}/car/carAllList',function(data){
			...
			$(data).each(function(i){
				...
				str += "<div class='car_box' data-cno='"+this.cno+"' data-carType='"+this.carType+"' data-car='"+this.car+"' data-cno='"+this.cno+"' onclick=check("+i+")>";
				str += "<a href='#' class='car_a' id='"+this.carType+"'>";
				str += "<strong class='car_name'>"+this.car+"</strong>";
				str += "<span class='car_img'>";
				str += "<img src='${path}/resources/carImg/"+this.cno+".png' name='all' alt='"+this.car+"' />";
				str += "</span>";
				str += "</a>";
				str += "</div>";
			});
