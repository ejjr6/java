						...
						<form id="searchForm">
							<div class="col-md-3">
								<select class="form-control" name="searchType">
									...
									<option value="cw" ${pm.cri.searchType == 'cw' ? 'selected' : ''}>content &amp; writer</option>
							...
							<div class="col-md-4">
								...
								<div class="col-md-6">
									<input id="newBtn" type="button" class="form-control btn btn-warning" value="NEW BOARD"/>
								</div>
							</div>
							<div class="col-md-2">
				...
				<div class="box-footer">
					<div class="text-center">
						<ul class="pagination">
							...
							<c:if test="${pm.prev}">
								<li>
									<a href="listPage${pm.query(pm.startPage-1)}">&laquo;&laquo;</a>
								</li>
							</c:if>
